...
public class webxampp extends AppCompatActivity {
    WebView web1;
    final String url="https://www.apachefriends.org/es/index.html";
    Button uno;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.webxampp);
        web1=findViewById(R.id.wwwxampp);
