...
public class Yotubecss3 extends YouTubeBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yotubecss3);
        ...
        player2.initialize(API_key, new YouTubePlayer.OnInitializedListener() {
            ...
            public void onInitializationFailure(YouTubePlayer.Provider provider, YouTubeInitializationResult youTubeInitializationResult) {
                Toast.makeText(Yotubecss3.this, youTubeInitializationResult.toString(), Toast.LENGTH_LONG).show();
            }
        });
