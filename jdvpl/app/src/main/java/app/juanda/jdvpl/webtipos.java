...
public class webtipos extends AppCompatActivity {
    WebView web1;
    final String url="https://www.anerbarrena.com/tipos-dato-mysql-5024/";
    Button uno;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_webtipos);
        web1=findViewById(R.id.www2);
